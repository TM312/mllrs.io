<template>
  <div class="">
    <div class="text-gray-500">
      <p v-if="$fetchState.pending" class="text-xs">
        Retrieving like levels...
      </p>
    </div>

    <button v-if="!$fetchState.error" type="button" class="w-20 inline-flex px-3.5 py-2 border border-transparent text-sm leading-4 font-medium rounded-full shadow-sm text-gray-800 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-50" @click="addLikesOnInterval">
