      ...
      <div class="flex justify-between h-16">
        <div class="flex px-2 lg:px-0">
          ...
          <div class="hidden lg:ml-6 lg:flex lg:space-x-8">
            ...
            <NuxtLink to="/" :class="this.$nuxt.$route.path === '/' ? classActiveD : classInactiveD">
              Main
            </NuxtLink>
            <!-- <NuxtLink to="/article" :class="this.$nuxt.$route.path === '/article' ? classActiveD : classInactiveD">
              Articles
            </NuxtLink> -->
          </div>
        </div>
        ...
        <div class="flex items-center lg:hidden">
          ...
          -->
            <img src="~/assets/svg/burger-menu.svg"></img>
            <img :src="require('~/assets/svg/burger-menu.svg')"></img>
        ...
        <div class="hidden lg:ml-4 lg:flex lg:items-center">
          ...
          <div class="ml-4 relative flex-shrink-0">
            <div>
              <NuxtLink to="/about" :class="this.$nuxt.$route.path === '/about' ? classActiveD : classInactiveD">
                About
              </NuxtLink>
            </div>
          </div>
  ...
  -->
    <div class="hidden lg:hidden">
      <div class="pt-2 pb-3 space-y-1">
        ...
        <a href="#" :class="classInactive">Dashboard</a>
        <a href="#" class="">Team</a>
...
export default {
  ...
  data () {
    return {
      classActiveD: 'border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium',
      classInactiveD: 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium'
