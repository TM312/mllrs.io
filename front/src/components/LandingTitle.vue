    ...
    <transition name="fade" appear>
      <div>
        ...
        <p
          ...
          <span
            class="inline-block max-w-[591px] align-top">I've
            built and shipped digital products both as a solo
            maker and product owner in the finance,
            automotive, and education sectors.</span>
        </p>
      </div>
    </transition>
  </div>
